...
#=====================================================================================================
# Reading Fits
file_path = "2pt_decade_ngc_20241128.fits"
...
theta = theta[:20]     
np.save('DECADE_NGC_shear_theta_p.npy',theta)
np.save('DECADE_NGC_shear_theta_m.npy',theta)
...
np.save('DECADE_NGC_shear_data_vector.npy',data_vector_xi)
np.save('DECADE_NGC_shear_cov_matrix.npy',cov_mat)
hdu.close()