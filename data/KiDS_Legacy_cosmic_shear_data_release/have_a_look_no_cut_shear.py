...
#=====================================================================================================
# Reading Fits
file_path = "KiDS_Legacy_xipm.fits"
...
theta = theta[:9]     
np.save('KiDS_Legacy_no_cut_shear_theta_p.npy',theta)
np.save('KiDS_Legacy_no_cut_shear_theta_m.npy',theta)
...
np.save('KiDS_Legacy_no_cut_shear_data_vector.npy',data_vector_xi)
np.save('KiDS_Legacy_no_cut_shear_cov_matrix.npy',cov_mat)
hdu.close()