...
#=====================================================================================================
# xi
cov_mat = hdu[1].data[:400,:400]
xi_p = hdu[2].data
xi_m = hdu[3].data
theta = xi_p.field('ANG')
theta = theta[:20]     
np.save('DES_no_cut_shear_theta_p.npy',theta)
np.save('DES_no_cut_shear_theta_m.npy',theta)
...
np.save('DES_no_cut_shear_data_vector.npy',data_vector_xi)
np.save('DES_no_cut_shear_cov_matrix.npy',cov_mat)
hdu.close()