...
class DES(Likelihood):
    ...
    def initialize(self):
        file_path = "../data/DECADE_SGC/2pt_decade_sgc_20250218.fits"
        ...
        #---------------------------------------
        # get data
        self.data_vector_xi = np.load('../data/DECADE_SGC/DECADE_SGC_shear_data_vector.npy')
        Cov =  np.load('../data/DECADE_SGC/DECADE_SGC_shear_cov_matrix.npy')          
        self.inv_C = np.linalg.inv(Cov)
        theta_arcmin_p = np.load('../data/DECADE_SGC/DECADE_SGC_shear_theta_p.npy')   
        self.theta_deg_p = theta_arcmin_p / 60
        theta_arcmin_m = np.load('../data/DECADE_SGC/DECADE_SGC_shear_theta_m.npy')   
        ...
        # get scale cuts
        self.safe_idx = np.load('../scale_cuts/safe_idx_decade_sgc.npy')
    ...
    def logp(self,**params_values):
        ...
        # here, parameters are passed from frlss theory
            ...
            A_IA = params_values['A_IA_decade_sgc']
            eta_IA = params_values['eta_IA_decade_sgc']
            logMc = pp.get_param('logMc')
            eta_b = pp.get_param('eta_b')
            dz1 = params_values['dz1_decade_sgc']
            dz2 = params_values['dz2_decade_sgc']
            dz3 = params_values['dz3_decade_sgc']
            dz4 = params_values['dz4_decade_sgc']
            m1 = params_values['m1_decade_sgc']
            m2 = params_values['m2_decade_sgc']
            m3 = params_values['m3_decade_sgc']
            m4 = params_values['m4_decade_sgc']
