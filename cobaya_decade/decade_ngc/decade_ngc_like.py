...
class DES(Likelihood):
    ...
    def initialize(self):
        file_path = "../data/DECADE_NGC/2pt_decade_ngc_20241128.fits"
        ...
        #---------------------------------------
        # get data
        self.data_vector_xi = np.load('../data/DECADE_NGC/DECADE_NGC_shear_data_vector.npy')
        Cov =  np.load('../data/DECADE_NGC/DECADE_NGC_shear_cov_matrix.npy')          
        self.inv_C = np.linalg.inv(Cov)
        theta_arcmin_p = np.load('../data/DECADE_NGC/DECADE_NGC_shear_theta_p.npy')   
        self.theta_deg_p = theta_arcmin_p / 60
        theta_arcmin_m = np.load('../data/DECADE_NGC/DECADE_NGC_shear_theta_m.npy')   
        ...
        # get scale cuts
        self.safe_idx = np.load('../scale_cuts/safe_idx_decade_ngc.npy')
    ...
    def logp(self,**params_values):
        ...
        # here, parameters are passed from frlss theory
            ...
            A_IA = params_values['A_IA_decade_ngc']
            eta_IA = params_values['eta_IA_decade_ngc']
            logMc = pp.get_param('logMc')
            eta_b = pp.get_param('eta_b')
            dz1 = params_values['dz1_decade_ngc']
            dz2 = params_values['dz2_decade_ngc']
            dz3 = params_values['dz3_decade_ngc']
            dz4 = params_values['dz4_decade_ngc']
            m1 = params_values['m1_decade_ngc']
            m2 = params_values['m2_decade_ngc']
            m3 = params_values['m3_decade_ngc']
            m4 = params_values['m4_decade_ngc']
