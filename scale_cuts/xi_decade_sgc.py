...
class CosmicShear:
    ...
    def set_cosmo(self, Om=0.3, Ob=0.05, h=0.7, ns=0.96, As=2.1e-9, mnu=0.06, fR0=-1e-5, dz1=0.0, dz2=0.0, dz3=0.0, dz4=0.0, m1=0.0, m2=0.0, m3=0.0, m4=0.0):
        Onu = mnu / 93.14 / h**2
        ...
        self.dzs = np.array([dz1,dz2,dz3,dz4])
        self.ms = np.array([m1,m2,m3,m4])
...
plt.ylabel('Error')
plt.tight_layout()        
plt.savefig('error_DECADE_SGC.png')
...
print(filtered_idx)
np.save('safe_idx_decade_sgc.npy', filtered_idx)